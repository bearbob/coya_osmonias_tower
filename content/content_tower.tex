...
\block{letsLeaveTheDungeon}{Ich gehe so schnell es geht}
...
Um die Tür zu öffnen wirst du kräftig ziehen müssen. Dir ist klar, dass das Geräusche machen wird. Wirf eine Athletikprobe mit DC 15. Wenn du Erfolg hast, gehe zu [\ref{escapeTroughTheMainDoor}]. Schaffst du es nicht, gehe zu [\ref{noEscapeFromSpider}].
...
\block{noEscapeFromSpider}{Nur über meine Leiche}
...
Reichweite 30;
Attacke: Biss (+4), 1d8+3 Schaden.
Die Spinne darf zuerst angreifen und hat beim ersten Angriff Vorteil, da sie dir in den Rücken fällt.\\
