...
Markiere Ereignis \getEvent{ihaveseentheirfaces}.
...
\block{inspectCargoFromloadramp}{Ich wende mich den Säcken zu}
...
\\Du erhälst eine Kartoffel \getItem{itemSimplePotato}!
\\Wenn du zurück zur Ladeklappe kriechen willst, gehe zu [\ref{returnLoadramp}].
\\Wenn du warten möchtest, gehe zu [\ref{waitInCart}].
...
Markiere Ereignis \getEvent{oneKidnapperDiedA} und gehe zu [\ref{arrivalAtTowerSingle}].
...
Markiere Ereignis \getEvent{oneKidnapperDiedB} und gehe zu [\ref{arrivalAtTowerSingle}].
...
Markiere Ereignis \getEvent{bothKidnappersDied}.
...
Aber du, du bist anders. Du siehst erfahren aus, vielleicht kannst du das Unmögliche wagen. Doch dann solltest du heimlich sein, denn wer den Hexer offen angreift, der kann wirklich nicht mit einem Sieg rechnen. Sie geben dir einen kleinen Dolch \getItem{itemSimpleDagger}, ein Kurzschwert \getItem{itemShortSword} und einen Trank der größeren Heilung \getItem{GreaterHealingPotion}. Dir ist klar, dass besonders der Heiltrank für die Männer ein wertvolles Gut ist. Dankbar verabschiedest du dich von deinen Helfern und läufst durch den Wald weiter in Richtung dieses mysterösen Turms.
