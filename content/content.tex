...
Du konzentrierst dich und sammelst deine Stärke für einen gezielten Tritt gegen die Seite der Holzklappe. Das Glück ist endlich auf deiner Seite, das Material gibt nach und bricht am Metallriegel. Ein nervöser Blick auf deine Entführer zeigt dir, dass sich überhaupt nicht bemerken, was du da treibst. Schnellst sammelst du dich für einen zweiten Tritt auf der anderen Seite und die Klappe fällt nach unten ab. Einige Herzschläge später rollst du seitwärts vom Wagen und fällst auf den steinigen Boden. Du verlierst 2 Lebenspunkte.\\
...
\\Wenn du zur Ladeklappe kriechen willst, gehe zu [\ref{loadramp2}].
\\Wenn du warten möchtest, gehe zu [\ref{waitInCart}].
